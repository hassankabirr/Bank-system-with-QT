...
shortTermSharedInvestment::shortTermSharedInvestment()
{
    set_interest_rate(5);
...
void shortTermSharedInvestment::calculateInterest(){
...
bool shortTermSharedInvestment::transferMoneyViaAccount(QString accStr, float amount){
